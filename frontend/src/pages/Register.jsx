...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // 2. Clear out or handle registration backend logic here if needed later...

        // 3. Navigate the user to the login page after successful registration submission
        navigate("/login");
    };

    const handleSignInNav = (e) => {
        e.preventDefault(); // Prevents standard link refresh behavior
        navigate("/login");
    };

    return (
        <div className="min-h-screen flex bg-[#0a0f24] font-sans relative overflow-hidden">
            {/* Background Concert Image with Dark Blue Radial Overlay */}
            ...
            <div className="relative z-10 w-full flex flex-col lg:flex-row items-center justify-center p-6 md:p-12 lg:gap-16 max-w-7xl mx-auto">
                ...
                <div className="hidden lg:flex flex-col text-white max-w-md space-y-6">
                    <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-xl bg-blue-600 flex items-center justify-center font-bold text-xl">E</div>
                    </div>
                ...
                {/* RIGHT SIDE: User Registration Form Card */}
                <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-white shadow-2xl shadow-black/40">
                    <div className="space-y-2 mb-6">
                        ...
                        <p className="text-sm text-slate-400">Create your account to continue your journey with us.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* System Portal Selector Grid */}
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold uppercase tracking-wider text-slate-400">Registering As</label>
