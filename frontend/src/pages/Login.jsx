        ...
        <div className="w-full max-w-md bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[35px] p-10 shadow-2xl">
          ...
          <form>
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className="text-blue-400 cursor-pointer text-sm">
                Forgot password?
              </span>
            </div>
            ...
            <input
              ...
              className="w-full p-4 rounded-xl mb-6 outline-none"
            />
            ...
            <button
              type="button"
              className="w-full bg-white text-black p-4 rounded-xl font-medium"
            >
              Sign in with Google
            </button>
